...
//Check if LOD level is greater than 0 and the sector isnt culled
	if(Quadtree->Culled==false)
	{
		...
		{
		//Part 1
			BT_Intern_UpdateTerrainRec(Terrain,Quadtree->n1,Level-1,IntersectingFrustum,LODLevelToDraw);

		//Part 2
			BT_Intern_UpdateTerrainRec(Terrain,Quadtree->n2,Level-1,IntersectingFrustum,LODLevelToDraw);

		//Part 3
			BT_Intern_UpdateTerrainRec(Terrain,Quadtree->n3,Level-1,IntersectingFrustum,LODLevelToDraw);

		//Part 4
			BT_Intern_UpdateTerrainRec(Terrain,Quadtree->n4,Level-1,IntersectingFrustum,LODLevelToDraw);
